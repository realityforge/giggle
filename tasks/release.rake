...
### [v#{ENV['PRODUCT_VERSION']}](https://github.com/realityforge/giggle/tree/v#{ENV['PRODUCT_VERSION']}) (#{ENV['RELEASE_DATE']})
[Full Changelog](https://github.com/realityforge/giggle/compare/#{from}...v#{ENV['PRODUCT_VERSION']})
HEADER
