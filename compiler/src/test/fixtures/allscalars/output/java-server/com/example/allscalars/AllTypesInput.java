...
public final class AllTypesInput {
  ...
  private AllTypesInput(final boolean requiredBoolean, @Nullable final Boolean optionalBoolean,
  ...
  public boolean equals(final Object o) {
    if ( this == o ) {
      ...
      return Objects.equals( requiredBoolean, that.requiredBoolean ) && Objects.equals( optionalBoolean, that.optionalBoolean ) && Objects.equals( requiredInt, that.requiredInt ) && Objects.equals( optionalInt, that.optionalInt ) && Objects.equals( requiredFloat, that.requiredFloat ) && Objects.equals( optionalFloat, that.optionalFloat ) && Objects.equals( requiredString, that.requiredString ) && Objects.equals( optionalString, that.optionalString ) && Objects.equals( requiredID, that.requiredID ) && Objects.equals( optionalID, that.optionalID ) && Objects.equals( requiredEnum, that.requiredEnum ) && Objects.equals( optionalEnum, that.optionalEnum ) && Objects.equals( requiredInput, that.requiredInput ) && Objects.equals( optionalInput, that.optionalInput ) && Objects.equals( requiredBooleanList, that.requiredBooleanList ) && Objects.equals( requiredBooleanListContainingNulls, that.requiredBooleanListContainingNulls ) && Objects.equals( optionalBooleanList, that.optionalBooleanList ) && Objects.equals( requiredIntList, that.requiredIntList ) && Objects.equals( requiredIntListContainingNulls, that.requiredIntListContainingNulls ) && Objects.equals( optionalIntList, that.optionalIntList ) && Objects.equals( requiredFloatList, that.requiredFloatList ) && Objects.equals( requiredFloatListContainingNulls, that.requiredFloatListContainingNulls ) && Objects.equals( optionalFloatList, that.optionalFloatList ) && Objects.equals( requiredStringList, that.requiredStringList ) && Objects.equals( requiredStringListContainingNulls, that.requiredStringListContainingNulls ) && Objects.equals( optionalStringList, that.optionalStringList ) && Objects.equals( requiredIDList, that.requiredIDList ) && Objects.equals( requiredIDListContainingNulls, that.requiredIDListContainingNulls ) && Objects.equals( optionalIDList, that.optionalIDList ) && Objects.equals( requiredEnumList, that.requiredEnumList ) && Objects.equals( requiredEnumListContainingNulls, that.requiredEnumListContainingNulls ) && Objects.equals( optionalEnumList, that.optionalEnumList ) && Objects.equals( requiredInputList, that.requiredInputList ) && Objects.equals( requiredInputListContainingNulls, that.requiredInputListContainingNulls ) && Objects.equals( optionalInputList, that.optionalInputList );
    }
  }

  @Override
  public int hashCode() {
    return Objects.hash( requiredBoolean, optionalBoolean, requiredInt, optionalInt, requiredFloat, optionalFloat, requiredString, optionalString, requiredID, optionalID, requiredEnum, optionalEnum, requiredInput, optionalInput, requiredBooleanList, requiredBooleanListContainingNulls, optionalBooleanList, requiredIntList, requiredIntListContainingNulls, optionalIntList, requiredFloatList, requiredFloatListContainingNulls, optionalFloatList, requiredStringList, requiredStringListContainingNulls, optionalStringList, requiredIDList, requiredIDListContainingNulls, optionalIDList, requiredEnumList, requiredEnumListContainingNulls, optionalEnumList, requiredInputList, requiredInputListContainingNulls, optionalInputList );
  }

  @Override
  public String toString() {
    return "AllTypesInput[requiredBoolean=" + requiredBoolean + ", optionalBoolean=" + optionalBoolean + ", requiredInt=" + requiredInt + ", optionalInt=" + optionalInt + ", requiredFloat=" + requiredFloat + ", optionalFloat=" + optionalFloat + ", requiredString=" + requiredString + ", optionalString=" + optionalString + ", requiredID=" + requiredID + ", optionalID=" + optionalID + ", requiredEnum=" + requiredEnum + ", optionalEnum=" + optionalEnum + ", requiredInput=" + requiredInput + ", optionalInput=" + optionalInput + ", requiredBooleanList=" + requiredBooleanList + ", requiredBooleanListContainingNulls=" + requiredBooleanListContainingNulls + ", optionalBooleanList=" + optionalBooleanList + ", requiredIntList=" + requiredIntList + ", requiredIntListContainingNulls=" + requiredIntListContainingNulls + ", optionalIntList=" + optionalIntList + ", requiredFloatList=" + requiredFloatList + ", requiredFloatListContainingNulls=" + requiredFloatListContainingNulls + ", optionalFloatList=" + optionalFloatList + ", requiredStringList=" + requiredStringList + ", requiredStringListContainingNulls=" + requiredStringListContainingNulls + ", optionalStringList=" + optionalStringList + ", requiredIDList=" + requiredIDList + ", requiredIDListContainingNulls=" + requiredIDListContainingNulls + ", optionalIDList=" + optionalIDList + ", requiredEnumList=" + requiredEnumList + ", requiredEnumListContainingNulls=" + requiredEnumListContainingNulls + ", optionalEnumList=" + optionalEnumList + ", requiredInputList=" + requiredInputList + ", requiredInputListContainingNulls=" + requiredInputListContainingNulls + ", optionalInputList=" + optionalInputList + "]";
  }
}
